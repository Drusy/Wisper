...
bool PauseLayer::init()
{
	...
	_labelName = CCLabelTTF::create("IntroScene", "Arial", 60 * _scale);
	...
	_labelName->runAction(CCSequence::create(CCFadeOut::create(0.0f), /// On le fait disparaitre
											...
											CCCallFunc::create(this, callfunc_selector(PauseLayer::endScene)), /// On appel la fonction pour mettre un terme à la scène.
											NULL));

    return true;
}

void PauseLayer::endScene()
{
