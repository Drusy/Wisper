...
bool IntroLayer::init()
{
	...
	_labelName = CCLabelTTF::create("IntroLayer", "Arial", 60 * _scale);
	...
	_labelName->runAction(CCSequence::create(CCFadeOut::create(0.0f), /// On le fait disparaitre
											...
											CCCallFunc::create(this, callfunc_selector(IntroLayer::endScene)), /// On appel la fonction pour mettre un terme à la scène.
											NULL));

    return true;
}

void IntroLayer::endScene()
{
